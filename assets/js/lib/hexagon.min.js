...
!function(t){t.fn.sao_hexagon=function(){t(this).find(".sao-icon-bh .sao-icon").each((function(r){var i={value:1,startAngle:Math.PI,animation:!1},o=t(this).attr("bgf"),a=t(this).attr("bgs"),n=t(this).attr("bgo");if(o){i.lineCap="round",i.clip=!0;var s={};s.color=o,a&&("true"==rtl_js.is_rtl?(s.color=a,s.color_2=o):s.color_2=a),n&&(s.ori=n),i.background=s}var l=t(this).attr("bos");l&&(i.lineWidth=l);var h=t(this).attr("boc");h&&(i.lineFrontFill={gradient:[h]}),t(this).hexagonProgress(i);var e={value:1,startAngle:Math.PI,animation:!1},c=t(this).attr("hbgf"),g=t(this).attr("hbgs"),b=t(this).attr("hbgo");if(c){e.lineCap="round",e.clip=!0;var u={};u.color=c,g&&("true"==rtl_js.is_rtl?(u.color=g,u.color_2=c):u.color_2=g),b&&(u.ori=b),e.background=u}var d=t(this).attr("hbos");d&&(e.lineWidth=d);var f=t(this).attr("hboc");f&&(e.lineFrontFill={gradient:[f]}),t(this).find("i").hexagonProgress(e)}))}}(jQuery);
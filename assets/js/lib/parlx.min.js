...
!function(a){a.fn.sao_parlx=function(){a(".sao-bg-parallax-top ").each((function(t,i){a(this).parlx({settings:{speed:.5}})})),a(".sao-bg-parallax-bottom ").each((function(t,i){a(this).parlx({settings:{speed:-.5}})})),a(".sao-bg-parallax-left").each((function(t,i){a(this).parlx({settings:{speed:.5,direction:"horizontal"}})})),a(".sao-bg-parallax-right").each((function(t,i){a(this).parlx({settings:{speed:.5,direction:"horizontal"}})}))}}(jQuery);

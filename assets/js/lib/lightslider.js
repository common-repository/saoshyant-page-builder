            ...
            controls: function () {
                if (settings.controls) {
                   ...
                   // $el.after('<div class="lSAction"><a class="lSPrev">' + settings.prevHtml + '</a><a class="lSNext">' + settings.nextHtml + '</a></div>');
                    ...
                    $slide.parents("[class*='sao-el'],[class*='rd-el']").find("[class*='arrow-next'],[class*='lSNext']").on('click', function (e) {
                        if (e.preventDefault) {
                            e.preventDefault();
					...
					$slide.parents("[class*='sao-el'],[class*='rd-el']").find("[class*='arrow-prev'],[class*='lSPrev']").on('click', function (e) {
                        if (e.preventDefault) {
                            e.preventDefault();
                        ...
                        if (settings.mode === 'slide') {
                            if ((v) >= w - elSize - settings.slideMargin) {
                                ...
                                if (i < minPgr) {
                                    ...
                                    $slide.parent().parent().addClass('sao-hide-arrow');
                                } else {
                                    $slide.parent().removeClass('noPager');
                                    $slide.parent().parent().removeClass('sao-hide-arrow');
                                }
                                break;
                            }
                        }

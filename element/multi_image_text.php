...
******************************************************************************************************************************************************
																  ...
																  Element  Multi Image Text
 
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if ( !function_exists ( "sao_element_item_multi_image_text" )){
add_filter('sao_element_item', 'sao_element_item_multi_image_text');
function sao_element_item_multi_image_text( $element ) {
 	
 	$element[]= array(
 		'name'			=> 	__('Multi Image & Text','saoshyant-page-builder'),
 		'id'			=> 'multi_image_text',
		'img'			=>  SAOPAGE_DIR.'assets/image/multi_image_text.jpg'
  	); 
...
******************************************************************************************************************************************************
																    ...
																    Multi Image Text Options
 
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if ( !function_exists ( "sao_multi_image_text_options" )){
add_filter('sao_element_options_multi_image_text', 'sao_multi_image_text_options');
function sao_multi_image_text_options( $option ) {
...
******************************************************************************************************************************************************
																   ...
																   Multi Image Text Config
 
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if ( !function_exists ( "sao_multi_image_text_config" )){
add_filter('sao_builder_multi_image_text', 'sao_multi_image_text_config');
function sao_multi_image_text_config( $args ) {

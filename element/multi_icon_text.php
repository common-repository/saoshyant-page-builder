...
******************************************************************************************************************************************************
																  ...
																  Element Multi Icon Text
 
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if ( !function_exists ( "sao_element_item_multi_icon_text" )){
add_filter('sao_element_item', 'sao_element_item_multi_icon_text');
function sao_element_item_multi_icon_text( $element ) {
 	
	$element[] = array(
 		'name'			=> 	__('Multi Icon & Text','saoshyant-page-builder'),
 		'id'			=> 'multi_icon_text',
		'img'			=>  SAOPAGE_DIR.'assets/image/multi_icon_text.jpg'
  	); 
...
******************************************************************************************************************************************************
																   ...
																   Multi Icon Text Options
 
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if ( !function_exists ( "sao_multi_icon_text_options" )){
add_filter('sao_element_options_multi_icon_text', 'sao_multi_icon_text_options');
function sao_multi_icon_text_options( $option ) {
	...
	/*----------------------------------------------------------------
 	...
 	$option[]= array( 
		...
		"options"		=>   array( 
			...
			"boxed-item-2"		=> __('Boxed item 2','saoshyant-page-builder'),
...
******************************************************************************************************************************************************
																   ...
																   Multi Icon Text Config
 
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////


if ( !function_exists ( "sao_multi_icon_text_config" )){
add_filter('sao_builder_multi_icon_text', 'sao_multi_icon_text_config');
function sao_multi_icon_text_config( $args ) {
	...
	<div class="sao-flex <?php  sao_multi_column($option);?>"> 
        ...
        foreach($option['list'] as $keys => $value):
            ...
            <div class="sao-item"> 
                ...
                <?php if($box_layout=='sao-boxed-multi-2') {?>
                <div class="sao-bg"></div> 
                <?php }?>
             
                <?php if(!empty($value['icon'])){sao_el_icon($value,$option);$option['icon']=true;}?>            
	...
	if( $box_layout=='sao-boxed-multi-1' ||  $box_layout =='sao-boxed-multi-2' ) {
